...
import { UserSearchesTableComlumns } from "./columns";
import GlobalFilter from "../components/GlobalFilter";
import Pagination from "../components/Pagination";
import { Link } from "react-router-dom";

function UserSearchesTable() {
  const user = useSelector((state) => state.users.showUser);

  const columns = useMemo(() => UserSearchesTableComlumns, []);
  const data = useMemo(() => user?.user_searches, [user?.user_searches]);
...
export default UserSearchesTable;
